...
switch block
    case 1
        if ~restart
            insimdata = imread(char('instruction/Exp2_instructions1a.jpg'));
            ...
            insimdata = imread(char('instruction/Exp2_instructions1b.jpg'));
            texins = Screen('MakeTexture', w, insimdata);
            Screen('DrawTexture', w, texins);
            DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
            Screen('Flip',w);
            ...
            if setting.mapcj==12
                insimdata = imread(char('instruction/Exp2_instructions1c_12.jpg'));
            else insimdata = imread(char('instruction/Exp2_instructions1c_21.jpg'));
            end
            texins = Screen('MakeTexture', w, insimdata);
            Screen('DrawTexture', w, texins);
            DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
            ...
            insimdata = imread(char('instruction/Exp2_instructions1d.jpg'));
            texins = Screen('MakeTexture', w, insimdata);
            Screen('DrawTexture', w, texins);
    ...
    case setting.nblocksprac1+1
        ...
        Beeper(261.63,.4,.3);
        if setting.mapcj==12
            insimdata = imread(char('instruction/Exp2_instructions2a_12.jpg'));
        else insimdata = imread(char('instruction/Exp2_instructions2a_21.jpg'));
        end
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
        ...
        if setting.mapcj==12
            insimdata = imread(char('instruction/Exp2_instructions2b_12.jpg'));
        else insimdata = imread(char('instruction/Exp2_instructions2b_21.jpg'));
        end
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
        ...
        if setting.mapcj==12
            insimdata = imread(char('instruction/Exp2_instructions2c_12.jpg'));
        else insimdata = imread(char('instruction/Exp2_instructions2c_21.jpg'));
        end
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
        ...
        insimdata = imread(char('instruction/Exp2_instructions2d.jpg'));
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
        Screen('Flip',w);
        ...
        insimdata = imread(char('instruction/Exp2_instructions2e.jpg'));
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        txtline = ['Experimenter, please press any mouse button to continue with block ' int2str(block) ' out of ' int2str(setting.ntotalblocksexp) '.'];
        DrawFormattedText(w, txtline, 'center', rect(4)-50, 255, [], [], [], 1.5);
    ...
    case setting.nblocksprac1+setting.nblocksprac2+1
        ...
        Beeper(261.63,.4,.3);
        insimdata = imread(char('instruction/Exp2_instructions3a.jpg'));
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        DrawFormattedText(w, instr.wait, 'center', rect(4)-50, 255, [], [], [], 1.5);
        Screen('Flip',w);
        ...
        insimdata = imread(char(['stimuli/casino' int2str(setting.casinos(block-2)) '.jpg']));
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins, [], CenterRectOnPoint([0 0 720 540],rect(3)/2,rect(4)/2));
        txtline = ['Welcome to the next casino: ' setting.casinonames{setting.casinos(block-2)} '!'];
        ...
        insimdata = imread(char('instruction/Exp2_instructions3b.jpg'));
        texins = Screen('MakeTexture', w, insimdata);
        Screen('DrawTexture', w, texins);
        txtline = ['Experimenter, please press any mouse button to continue with block ' int2str(block) ' out of ' int2str(setting.ntotalblocksexp) '.'];
        DrawFormattedText(w, txtline, 'center', rect(4)-50, 255, [], [], [], 1.5);
    ...
    case setting.whenbreak
        ...
        Beeper(261.63,.4,.3);
        txtline = ['It''s time to leave ' setting.casinonames{setting.casinos(block-3)} '.'];
        rct = CenterRectOnPoint(Screen('TextBounds',w,txtline),rect(3)/2,rect(4)/2);
        Screen('DrawText',w,txtline,rct(1),rct(2)-50,255);
        txtline = ['In the ' int2str(setting.ntrialsall(blockorder(block-1))-testlist.Nobsblock(block-1)) ' choice trials, you won ' int2str(testlist.win(block-1)) ' points (£' num2str(testlist.win(block-1)*1/3000,'%1.2f') ').'];
        rct = CenterRectOnPoint(Screen('TextBounds',w,txtline),rect(3)/2,rect(4)/2);
        Screen('DrawText',w,txtline,rct(1),rct(2)-25,255);
        txtline = ['So far, you have won ' int2str(data.cumwin(end)) ' points in this experiment (£' num2str(data.cumwin(end)*1/3000,'%1.2f') ').'];
        rct = CenterRectOnPoint(Screen('TextBounds',w,txtline),rect(3)/2,rect(4)/2);
